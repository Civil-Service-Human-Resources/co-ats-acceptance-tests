...
object FULL_PEC_FORM_DATA
    extends PecFormDetails(
      ...
      FULL_PEC_FORM_NATIONAL_SECURITY_VETTING,
...
object FULL_PEC_FORM_YOUR_DETAILS
    extends YourDetails(
      "Mr",
      true,
      "JA123456D",
...
object FULL_PEC_FORM_UPLOAD_IDENTITY_DOCS
    extends IdentityDocDetails(
      "Test-T&Cs.pdf"
    )

object FULL_PEC_RIGHT_TO_WORK
    extends RtwDetails(
...
object FULL_PEC_FORM_DBS_PERSONAL_INFO
...
object FULL_PEC_FORM_DBS_ADDRESS_DETAILS
...
object FULL_PEC_FORM_DIGITAL_IDENTITY_CHECK
...
object FULL_PEC_FORM_EMPLOYMENT_HISTORY
...
object FULL_PEC_FORM_VERIFYING_HISTORY
...
object FULL_PEC_FORM_PENSION_QUESTIONNAIRE
...
object FULL_PEC_FORM_NATIONAL_SECURITY_VETTING
    extends NsvDetails(
      s"$randomLastName",
