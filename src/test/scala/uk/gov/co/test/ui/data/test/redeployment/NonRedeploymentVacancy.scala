...
object NON_REDEPLOYMENT_VACANCY_DATA
    extends NewVacancyDetails(
      NON_REDEPLOYMENT_BASIC_DETAILS,
      NON_REDEPLOYMENT_JOB_INFORMATION,
      NON_REDEPLOYMENT_APPROACH,
      NON_REDEPLOYMENT_APPROVAL,
      NON_REDEPLOYMENT_RESERVE_LIST,
      NON_REDEPLOYMENT_LOCATIONS,
      NON_REDEPLOYMENT_CONTRACT_DETAILS,
      NON_REDEPLOYMENT_ADVERT,
      NON_REDEPLOYMENT_CONTACT_DETAILS,
      NON_REDEPLOYMENT_VETTING_DETAILS,
      NON_REDEPLOYMENT_INTERVIEWS_DETAILS,
      NON_REDEPLOYMENT_SUCCESS_PROFILES,
      NON_REDEPLOYMENT_VACANCY_TESTS,
      NON_REDEPLOYMENT_ADDITIONAL_QUESTIONS,
      NON_REDEPLOYMENT_CRITERIA,
      NON_REDEPLOYMENT_MANAGEMENT,
      NON_REDEPLOYMENT_ONLINE_PEC_CHECK_FORMS,
      NON_REDEPLOYMENT_PEC_CHECK_FORMS
    )
...
object NON_REDEPLOYMENT_APPROACH
...
object NON_REDEPLOYMENT_APPROVAL
...
object NON_REDEPLOYMENT_LOCATIONS
...
object NON_REDEPLOYMENT_CONTRACT_DETAILS
...
object NON_REDEPLOYMENT_ADVERT
...
object NON_REDEPLOYMENT_CONTACT_DETAILS
...
object NON_REDEPLOYMENT_VETTING_DETAILS
...
object NON_REDEPLOYMENT_INTERVIEWS_DETAILS
...
object NON_REDEPLOYMENT_SUCCESS_PROFILES
    extends SuccessProfilesDetails(
      ...
      true,
      true,
      Some(NON_REDEPLOYMENT_ABILITIES),
      Some(NON_REDEPLOYMENT_BEHAVIOURS),
      Some(NON_REDEPLOYMENT_EXPERIENCES),
      Some(NON_REDEPLOYMENT_STRENGTHS),
      Some(NON_REDEPLOYMENT_TECH_SKILLS)
    )

object NON_REDEPLOYMENT_ABILITIES
...
object NON_REDEPLOYMENT_BEHAVIOURS
...
object NON_REDEPLOYMENT_STRENGTHS
...
object NON_REDEPLOYMENT_TECH_SKILLS
...
object NON_REDEPLOYMENT_VACANCY_TESTS
    extends VacancyTestsDetails(
      ...
      Some(NON_REDEPLOYMENT_RECRUITER_TESTS),
      Some(NON_REDEPLOYMENT_GROUP_A_TESTS),
      Some(NON_REDEPLOYMENT_GROUP_B_TESTS),
      Some(NON_REDEPLOYMENT_GROUP_C_TESTS)
    )

object NON_REDEPLOYMENT_RECRUITER_TESTS
...
object NON_REDEPLOYMENT_GROUP_A_TESTS
...
object NON_REDEPLOYMENT_GROUP_B_TESTS
...
object NON_REDEPLOYMENT_GROUP_C_TESTS
...
object NON_REDEPLOYMENT_MANAGEMENT
...
object NON_REDEPLOYMENT_ONLINE_PEC_CHECK_FORMS
...
object NON_REDEPLOYMENT_PEC_CHECK_FORMS
