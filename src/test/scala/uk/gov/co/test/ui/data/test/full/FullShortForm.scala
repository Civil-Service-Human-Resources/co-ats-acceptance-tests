...
object FULL_SHORT_FORM_DATA
    extends ShortFormDetails(
      FULL_SHORT_FORM_APP_GUIDANCE,
      FULL_SHORT_FORM_ELIGIBILITY,
      FULL_SHORT_FORM_PERSONAL_INFO,
      FULL_SHORT_FORM_DIVERSITY_MONITORING,
      FULL_SHORT_FORM_DECLARATION
    )

object FULL_SHORT_FORM_APP_GUIDANCE
    extends AppGuidanceDetails(
      true
    )

object FULL_SHORT_FORM_ELIGIBILITY
...
object FULL_SHORT_FORM_PERSONAL_INFO
...
object FULL_SHORT_FORM_DIVERSITY_MONITORING
...
object FULL_SHORT_FORM_DECLARATION
