...
object NON_NAME_BLIND_SHORT_FORM_DATA
    extends ShortFormDetails(
      NON_NAME_BLIND_SHORT_FORM_APP_GUIDANCE,
      NON_NAME_BLIND_SHORT_FORM_ELIGIBILITY,
      NON_NAME_BLIND_SHORT_FORM_PERSONAL_INFO,
      NON_NAME_BLIND_SHORT_FORM_DIVERSITY_MONITORING,
      NON_NAME_BLIND_SHORT_FORM_DECLARATION
    )

object NON_NAME_BLIND_SHORT_FORM_APP_GUIDANCE
    extends AppGuidanceDetails(
      true
    )

object NON_NAME_BLIND_SHORT_FORM_ELIGIBILITY
...
object NON_NAME_BLIND_SHORT_FORM_PERSONAL_INFO
...
object NON_NAME_BLIND_SHORT_FORM_DIVERSITY_MONITORING
...
object NON_NAME_BLIND_SHORT_FORM_DECLARATION
