...
import uk.gov.co.test.ui.data.MasterVacancyDetails.{vXAnyAdditionalQuestions, vXBehavioursRequired, vXExperiencesRequired, vXGiveLocationPreference, vXTechSkillsRequired, vXAttachmentRequired}
