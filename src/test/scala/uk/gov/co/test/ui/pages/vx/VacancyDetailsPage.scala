...
object VacancyDetailsPage extends VacancyBasePage {
  ...
  private lazy val applicationSummaryPageTitle = "Application Summary  : Civil Service Jobs - GOV.UK"
  ...
  private lazy val previewJobPath              = ".//a[@aria-label='Preview advert Details Summary']"
