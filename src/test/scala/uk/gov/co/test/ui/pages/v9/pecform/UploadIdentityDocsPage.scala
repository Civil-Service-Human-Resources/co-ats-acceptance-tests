...
object UploadIdentityDocsPage extends CivilServiceJobsBasePage {
  ...
  def uploadDocTwoId                          = s"${pecFormId}_datafield_159141_1_1"
  def uploadDocThreeId                        = s"${pecFormId}_datafield_159156_1_1"
  def uploadDocFourId                         = s"${pecFormId}_datafield_159186_1_1"
  def uploadDocFiveId                         = s"${pecFormId}_datafield_159201_1_1"
  def uploadDocSixId                          = s"${pecFormId}_datafield_159216_1_1"
  def uploadDocSevenId                        = s"${pecFormId}_datafield_159231_1_1"
  ...
  private def uploadIdentityDocuments(identityDocDetails: IdentityDocDetails): Unit = {
    ...
    attachDocuments(uploadDocTwoId, identityDocDetails.identityDoc)
    attachDocuments(uploadDocThreeId, identityDocDetails.identityDoc)
    attachDocuments(uploadDocFourId, identityDocDetails.identityDoc)
    attachDocuments(uploadDocFiveId, identityDocDetails.identityDoc)
    attachDocuments(uploadDocSixId, identityDocDetails.identityDoc)
  }
