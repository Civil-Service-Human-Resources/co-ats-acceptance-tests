...
object IDVT_LONG_FORM_DATA
    extends LongFormDetails(
      IDVT_LONG_FORM_EXPERIENCE_SKILLS,
      IDVT_LONG_FORM_CV,
      IDVT_LONG_FORM_PERSONAL_STATEMENT,
      IDVT_LONG_FORM_BEHAVIOURS,
      IDVT_LONG_FORM_TECHNICAL_SKILLS,
      IDVT_LONG_FORM_UPLOAD_DOCUMENTS,
      IDVT_LONG_FORM_PREFERENCES,
      IDVT_LONG_FORM_ROLE_QUESTIONS,
      IDVT_LONG_FORM_DECLARATION
    )

object IDVT_LONG_FORM_EXPERIENCE_SKILLS
    extends ExperienceAndSkillsDetails(
      true,
      s"$valid250Characters"
    )

object IDVT_LONG_FORM_CV
    extends CVDetails(
      s"$valid250Characters",
      s"$valid250Characters",
...
object IDVT_LONG_FORM_PERSONAL_STATEMENT
    extends StatementDetails(
      s"$valid250Characters",
      true
    )

object IDVT_LONG_FORM_BEHAVIOURS
    extends BehavioursDetails(
      s"$valid250Characters"
    )

object IDVT_LONG_FORM_TECHNICAL_SKILLS
  extends TechSkillsDetails(
    s"$valid250Characters"
  )

object IDVT_LONG_FORM_UPLOAD_DOCUMENTS
    extends UploadDocumentsDetails(
      "Test-T&Cs.pdf"
    )

object IDVT_LONG_FORM_PREFERENCES
...
object IDVT_LONG_FORM_ROLE_QUESTIONS
...
object IDVT_LONG_FORM_DECLARATION
