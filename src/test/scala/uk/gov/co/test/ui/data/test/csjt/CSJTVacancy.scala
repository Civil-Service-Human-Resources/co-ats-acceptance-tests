package uk.gov.co.test.ui.data.test.csjt
...
object CSJT_BASIC_DETAILS
    extends BasicDetails(
      ...
      s"Automation: Online Tests-CO - " + generateRandomJobPosition(),
      false,
      "Prawf awtomeiddio",
      32
    )
...
object CSJT_ADVERT
    extends AdvertDetails(
      "Autotest - job summary for online tests",
      "Autotest - job description for online tests",
      "Autotest - person specification for online tests",
      "Autotest - offered benefits for online tests",
      "Autotest - selection process for online tests"
    )
