...
import uk.gov.co.test.ui.data.v9.applicants.REGISTER_CANDIDATE_PEC_1
...
class PecVacancySpec extends BaseFeatureSpec {
  Feature("Candidate & Recruiter Complete The PEC Form") {
    Scenario("VX: A Candidate Completes The Candidate PEC Forms; Partial Application Process", Retryable) {
...
//    Scenario("VX: A Candidate Completes The Candidate PEC Forms With Workplace Misconduct Section", Retryable) {
//      Given("candidate registers for new job application")
